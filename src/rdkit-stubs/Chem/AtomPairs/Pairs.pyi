...
def pyScorePair(self, at1, at2, dist, atomCodes=None, includeChirality=False):
    """
...
def ExplainPairScore(self, score, includeChirality=False):
    """
    >>> from rdkit import Chem
...
def GetAtomPairFingerprintAsBitVect(self, mol):
    """
