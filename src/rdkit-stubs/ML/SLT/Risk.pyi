...
def log2(self, x): ...
def BurgesRiskBound(self, VCDim, nData, nWrong, conf):
    """
...
def CherkasskyRiskBound(self, VCDim, nData, nWrong, conf, a1=1.0, a2=2.0):
    """
...
def CristianiRiskBound(self, VCDim, nData, nWrong, conf):
    """
