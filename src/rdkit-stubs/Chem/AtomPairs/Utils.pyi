...
def ExplainAtomCode(self, code, branchSubtract=0, includeChirality=False):
    """
    Arguments:
...
def DiceSimilarity(self, v1, v2, bounds=None):
    """
