...
def EnumerateReaction(
    ...
    reaction,
    bbLists,
    uniqueProductsOnly=False,
    funcGroupFilename="/scratch/RDKit_git/Data/Functional_Group_Hierarchy.txt",
...
def PreprocessReaction(self, reaction, funcGroupFilename=None, propName="molFileValue"):
    """
